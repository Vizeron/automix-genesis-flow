...
const HeroSection = () => {
  ...
  return (
    <section id="hero" className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-primary-glow/5 rounded-full blur-3xl animate-float" style={{ animationDelay: '1s' }}></div>
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          ...
          {/* Subheading */}
          <p className="text-xl lg:text-2xl text-foreground-secondary mb-8 max-w-3xl mx-auto animate-fade-in" style={{ animationDelay: '0.2s' }}>
          ...
          <div className="mb-16 animate-fade-in" style={{ animationDelay: '0.4s' }}>
            <button
              ...
              className="neuro-button-primary px-8 py-4 rounded-lg text-lg font-medium inline-flex items-center space-x-2 group"
            >
          ...
          {/* 3D Floating Object */}
          <div className="relative flex justify-center animate-fade-in" style={{ animationDelay: '0.6s' }}>
            <div className="relative">
              ...
              {/* Floating Elements */}
              <div className="absolute -top-4 -right-4 w-16 h-16 glass-card rounded-2xl animate-float" style={{ animationDelay: '0.5s' }}>
                <div className="w-full h-full bg-primary/20 rounded-2xl"></div>
              </div>
              <div className="absolute -bottom-6 -left-6 w-12 h-12 glass-card rounded-xl animate-float" style={{ animationDelay: '1.5s' }}>
                <div className="w-full h-full bg-primary-glow/30 rounded-xl"></div>
              </div>
              <div className="absolute top-8 -left-8 w-8 h-8 bg-primary rounded-full glow-border animate-float" style={{ animationDelay: '2s' }}></div>
            </div>
          </div>
        </div>
      </div>
