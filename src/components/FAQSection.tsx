          ...
          {faqs.map((faq, index) => (
            ...
            >
              <button
                ...
                className="w-full p-6 text-left flex items-center justify-between hover:bg-background-tertiary/30 transition-colors duration-200"
              >
                ...
                <div className="flex-shrink-0">
                  {openItems.includes(index) ? (
                    <Minus size={20} className="text-primary" weight="bold" />
                  ) : (
