        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10 mb-8">
          ...
          <div className="order-3 md:order-3">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
              {socialLinks.map(social => <a key={social.label} href={social.href} target="_blank" rel="noopener noreferrer" className="w-10 h-10 glass-card rounded-lg flex items-center justify-center hover:scale-110 transition-transform duration-200 group" aria-label={social.label}>
